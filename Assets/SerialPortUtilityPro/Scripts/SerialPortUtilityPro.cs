...
namespace SerialPortUtility
{
	...
	{
		//Version Infomation
		public const string VersionString = "2.72 TRIAL";
		...
		private bool IsOpenProcess = false;
		...
		public void Open()
		{
			...
			IsOpenProcess = true;
			StartCoroutine(OpenProcessing());
		}

		private System.Collections.IEnumerator OpenProcessing()
		{
